...
import { Users, ShoppingBag, Package, BarChart, Tag, Star, Bell } from 'lucide-react';
    ...
    <div className="p-6 bg-black min-h-screen text-gray-100">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-teal-400">MegaMart Admin Panel</h1>
          <button 
            ...
            >
              <div className="p-5">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <span className="text-2xl font-bold text-teal-400">{card.count}</span>
                </div>
                <h2 className="text-xl font-semibold text-teal-300 mb-1">{card.title}</h2>
